...
int					exec_one_cmd(t_com *cmd, t_config *data,
						int original_fds[2]);
int					exec_builtin(t_com *cmd, t_config *data,
						int original_fds[2]);
int					has_pipe(t_tokens *tokens);
int					exec_multi(t_com *cmd, t_config *data, int original_fds[2]);
int					exec_fork_builtin(t_com *cmd, t_config *data,
						int original_fds[2]);
...
int					exec_com_multi(t_com *cmd, t_config *data,
						int original_fds[2]);
